# 🚨 URGENT: Fix "Cannot connect to database" Error
...
7. **Replace `[YOUR-PASSWORD]`** with your actual database password
   - If you don't know the password, go to **Settings** → **Database** → **Database password** to reset it

### Step 2: Add DATABASE_URL in Netlify Dashboard

**⚠️ CRITICAL: You MUST do this in the Netlify Dashboard, NOT in netlify.toml**
...
- ✅ The value starts with `postgresql://` (not `postgresql://build:build@build:5432/build`)
- ✅ The value contains your real Supabase hostname (`db.eulpiddbrbqchwrkulug.supabase.co`)
...
**⚠️ IMPORTANT: You MUST redeploy after adding DATABASE_URL**
...
3. **Check if database is accessible:**
   ...
   - If you can't connect, check Supabase settings → Database → Connection pooling
